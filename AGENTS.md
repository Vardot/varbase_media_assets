...
Guidance for AI coding agents working on the Varbase Media Assets recipe.
...
- **Merge request comments and history** on
  [git.drupalcode.org/project/varbase_media_assets](https://git.drupalcode.org/project/varbase_media_assets/-/merge_requests)
  — the reasoning behind recent changes lives in the MR discussions.
- **Issue comments** on
  [drupal.org/project/issues/varbase_media_assets](https://www.drupal.org/project/issues/varbase_media_assets)
